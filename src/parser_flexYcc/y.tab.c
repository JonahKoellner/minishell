...
{
      11,     0,    -1,    12,    -1,    13,    -1,    12,     7,    13,
      -1,     9,    14,    16,    -1,    15,    -1,    14,    15,    -1,
       9,    -1,    17,    -1,    18,    -1,    19,    -1,     4,     9,
      -1,     3,     9,    -1,     5,     9,    -1
};
...
{
       0,    87,    87,    94,   100,   108,   121,   122,   128,   131,
     132,   133,   136,   142,   148
};
#endif
...
{
  "$end", "error", "$undefined", "GREAT", "LESS", "GREATGREAT",
  "LESSLESS", "PIPE", "AND", "WORD", "$accept", "program", "command_list",
  "command", "arguments", "argument", "redirect", "input_redirect",
  "output_redirect", "append_redirect", 0
};
#endif
...
{
       0,     9,    11,    12,    13,     9,    14,    15,     0,     7,
       3,     4,     5,    15,    16,    17,    18,    19,    13,     9,
       9,     9
};
...
#line 109 "minishell.y"
  ...
  case 7:
#line 123 "minishell.y"
    {
              insertArgument((yyvsp[(2) - (2)]));
          }
    break;

  case 12:
#line 137 "minishell.y"
    {
                   _currentCommand._input_file = strdup((yyvsp[(2) - (2)]));
               }
    break;

  case 13:
#line 143 "minishell.y"
    {
                    _currentCommand._out_file = strdup((yyvsp[(2) - (2)]));
                }
    break;

  case 14:
#line 149 "minishell.y"
    {
                    _currentCommand._out_file = strdup((yyvsp[(2) - (2)]));
                }
    break;
